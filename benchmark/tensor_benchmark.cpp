...
void BtimesAplusdI(
  poly::math::MutSquarePtrMatrix<std::array<std::array<double, 9>, 3>> C,
  poly::math::MutSquarePtrMatrix<std::array<std::array<double, 9>, 3>> A,
  poly::math::MutSquarePtrMatrix<std::array<std::array<double, 9>, 3>> B,
  double doffset) {
  using T = std::array<std::array<double, 9>, 3>;
