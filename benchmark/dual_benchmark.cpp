...
template <typename T, ptrdiff_t N> struct ManualDual {
  T value;
  poly::math::SVector<T, N> partials;
};

template <std::floating_point T, ptrdiff_t N> struct ManualDual<T, N> {
  T value;
  poly::simd::Vec<N, T> partials;
};
template <typename T, ptrdiff_t N>
[[gnu::always_inline]] constexpr auto operator*(const ManualDual<T, N> &a,
                                                const ManualDual<T, N> &b)
  -> ManualDual<T, N> {
